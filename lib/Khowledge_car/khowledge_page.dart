...
class _DashboardState extends State<Dashboard> {
  ...
  var descList = [
    ...
    "รอบการเช็กระบบเบรกสำหรับชุดเบรกล้อหน้าควรตรวจเช็กเมื่อขับขี่ถึงระยะ 5,000 กิโลเมตร หรือทุก 6 เดือน ส่วนชุดเบรกล้อหลังควรตรวจเช็กเมื่อขับขี่ถึง\tระยะ 10,000 กิโลเมตร หรือทุก 6 เดือนเช่นกัน ท่อน้ำมันเบรกควรเช็กเมื่อขับขี่ถึงระยะ 10,000 กิโลเมตร หรือทุก 6 เดือน เนื่องจากเมื่อใช้งานมา\tระยะหนึ่งท่อน้ำมันเบรกอาจเกิดการรั่วซึมได้ ในส่วนน้ำมันเบรกควรเช็กเมื่อขับขี่ถึงระยะ 40,000 กิโลเมตร หรือทุก 24 เดือน ซึ่งหากใช้งานน้ำมันเบรกที่เสื่อมคุณภาพก็อาจส่งผลต่อประสิทธิภาพในการเบรกได้",
